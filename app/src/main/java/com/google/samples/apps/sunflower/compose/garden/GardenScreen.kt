...
private fun GardenListItem(
    ...
    Card(
        ...
        Column(Modifier.fillMaxWidth().background(color = (if (!isWatered) Color.White else Color.hsv(200f, 0.73f, 0.92f)))) {
            SunflowerImage(
                model = vm.imageUrl,
            ...
            //Water Icon
            IconButton(onClick = { isWatered = !isWatered },
                Modifier
                    .align(Alignment.CenterHorizontally)
                    .height(50.dp)
                    .width(50.dp),
                ...
                if(!isWatered) {
                    Image(
                        painter = painterResource(id = R.drawable.watering_can_svgrepo_com),
